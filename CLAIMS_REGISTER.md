...
| AUX-019 | Corpus/DI path **30/30 PASS** (2026-07-28). GGUF generative vs live product **23/30 (76.7%) FAIL** on 2026-08-02 — below 80%. Safe fixes implemented: grounding excerpts, keyword aliases, silica corpus, `ExpandSearchTerms`, `_publish/web` refresh (2026-08-02), compose/warm guarded against llama3.2 Modelfile clobber. Offline alias rescore **24/30=80%** (`eval/reports/..._alias_rescore.json`) — **not** live PASS. **PARTIAL** until product host deploy + dated live report ≥80% (prefer final tip). |
